...
const seat_updates_gateway_1 = require("./seat-updates.gateway");
...
exports.RealtimeModule = RealtimeModule = __decorate([
    (0, common_1.Module)({
        providers: [seat_updates_gateway_1.SeatUpdatesGateway],
        exports: [seat_updates_gateway_1.SeatUpdatesGateway],
    })
], RealtimeModule);
