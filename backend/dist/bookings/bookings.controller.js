...
const create_physical_booking_dto_1 = require("./dto/create-physical-booking.dto");
...
let BookingsController = class BookingsController {
    ...
    createPhysical(dto, req) {
        return this.bookingsService.createPhysicalBooking(dto, req.user?.sub ?? 0, req.user?.role ?? enums_1.Role.CUSTOMER);
    }
    listMine(req) {
...
__decorate([
    ...
    (0, common_1.Post)('physical'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_physical_booking_dto_1.CreatePhysicalBookingDto, Object]),
    __metadata("design:returntype", void 0)
], BookingsController.prototype, "createPhysical", null);
__decorate([
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(enums_1.Role.CUSTOMER),
    (0, common_1.Get)('me'),
